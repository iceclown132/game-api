...
import org.spartan.cdi.util.GsonSupplier;
...
public class ItemDefinition {
	...
	public static void initialize(@Observes ContainerInitialized event) throws Exception{
		InputStream stream = ClassLoader.getSystemResourceAsStream("game/item_def.json");
		definitions = GsonSupplier.supply().fromJson(new InputStreamReader(stream, Charset.forName("UTF-8")), ItemDefinition[].class);
